...
#	3. Verify async IOPS is at least 85% of sync IOPS for every combo.
#	4. Restore zfs_async_dio_enabled.
#

verify_runnable "global"

typeset -a iodepths=(1 8 32 64)
typeset -a numjobss=(1 32 64)
...
log_note "numjobs=1 speedup at iodepth=64: async is " \
    "$(( async_iops[1,64] * 100 / sync_iops[1,64] ))% of sync"
